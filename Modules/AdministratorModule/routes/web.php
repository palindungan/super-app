...
use Modules\AdministratorModule\Http\Controllers\Company\Branch\BranchUserController;
...
Route::prefix('administrator')->middleware(['auth'])->name('administrator.')->group(function () {
    Route::resource('companies.branches.branch_users', BranchUserController::class);
